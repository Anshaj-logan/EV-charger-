...
class ChargingRegister extends StatelessWidget {
  const ChargingRegister({super.key});
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  void ChargingRegisterUser() async {
    setState(() {
      _isLoading = true;
    });
    ...
    print(data);
    var res = await Api().authData(data, '/api/user/charging-station-register');
