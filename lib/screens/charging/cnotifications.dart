...
class _CnotificationsState extends State<Cnotifications> {
  ...
  late String charging_station_name;
  ...
  void AddNotification() async {
    ...
    print('User login ${chargingStationIid}');
    charging_station_name =
        (localStorage.getString('charging_station_name') ?? '');
    print('charging name ${charging_station_name}');
    ...
    var data = {
      ...
      "charging_station_name": charging_station_name.replaceAll('"', ''),
      "date": startDate,
    ...
    if (body['success'] == true) {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => Charginghome()));
    } else {
      Fluttertoast.showToast(
        msg: body['message'].toString(),
        backgroundColor: Colors.grey,
