...
import '../api.dart';
import 'battery_editprofile.dart';
import 'batteryshophome.dart';

class BatteryProfile extends StatefulWidget {
  const BatteryProfile({Key? key}) : super(key: key);

  @override
  State<BatteryProfile> createState() => _BatteryProfileState();
}

class _BatteryProfileState extends State<BatteryProfile> {
  ...
  _fetchData() async {
    ...
    var res = await Api().getData(
        '/api/user/view-battery-shop-profile/' + Log_id.replaceAll('"', ''));
    print(res);
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () => Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => const Batteryhome())),
