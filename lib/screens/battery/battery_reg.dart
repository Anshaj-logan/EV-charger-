...
class BatteryshopRegister extends StatelessWidget {
  const BatteryshopRegister({super.key});
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  void BatteryshopRegisterUser() async {
    setState(() {
      _isLoading = true;
    });
    ...
    print(data);
    var res = await Api().authData(data, '/api/user/battery-shop-register');
