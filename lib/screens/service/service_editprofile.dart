...
class ServiceEditProfile extends StatefulWidget {
  String _id;
  String Log_id;

  ServiceEditProfile(this._id, this.Log_id);

  @override
  State<ServiceEditProfile> createState() => _ServiceEditProfileState();
}

class _ServiceEditProfileState extends State<ServiceEditProfile> {
...
/*  Future<void> getLogin() async {
  ...
  Future<void> _viewUser() async {
    ...
    print('Log_id ${_id}');
    var res =
        await Api().getData('/api/user/view-service-station-profile/' + _id);
  ...
  _update() async {
    ...
    print(data);
    var res =
        await Api().authData(data, '/api/user/update-service-station/' + _id);
    var body = json.decode(res.body);
    print(res);
