...
import 'package:newpro/screens/user/user_editprofile.dart';
...
class _UserProfileState extends State<UserProfile> {
  ...
  _fetchData() async {
    ...
    var res = await Api()
        .getData('/api/user/view-user-profile/' + Log_id.replaceAll('"', ''));
    print(res);
            ...
            IconButton(
                onPressed: () async {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => UserEditProfile(_id, Log_id)));
                },
